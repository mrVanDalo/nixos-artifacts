...
- **Feature flag count discrepancy:** SUMMARY.md claimed "63 sites" but actual
  count is 50. Both numbers confirm substantial feature usage.
- **Test failure:** One test fails (`backend::tempfile::tests::test_as_ref`) but
  this is a pre-existing issue unrelated to dependency audit.
- **Dependency hygiene:** Excellent - no unused deps, all features active,
  unavoidable duplicates only.
