...
**Phase Goal:** TUI errors display properly to stderr without polluting normal
output
...
**Note:** The 4 eprintln! calls in terminal.rs (lines 47, 53, 59, 117) are
...
The 6 println! calls in backend/prompt.rs (lines 67, 68, 69, 119, 120, 158, 172)
are INTENTIONAL for headless mode user interaction - they occur before TUI
starts and are documented as acceptable.
