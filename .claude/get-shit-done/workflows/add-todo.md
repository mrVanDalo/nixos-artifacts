...
Extract from init JSON: `commit_docs`, `date`, `timestamp`, `todo_count`,
`todos`, `pending_dir`, `todos_dir_exists`.
...
[problem description - enough context for future Claude to understand weeks
later]
