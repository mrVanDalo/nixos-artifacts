...
hypothesis: [current theory being tested] test: [how testing it] expecting:
[what result means if true/false] next_action: [immediate next step]
...
messages if any] reproduction: [how to trigger] started: [when it broke / always
broken]
...
- timestamp: [when found] checked: [what was examined] found: [what was
  observed] implication: [what this means]
...
The file IS the debugging brain. Claude should be able to resume perfectly from
...
If evidence grows very large (10+ entries), consider whether you're going in
circles. Check Eliminated to ensure you're not re-treading.
