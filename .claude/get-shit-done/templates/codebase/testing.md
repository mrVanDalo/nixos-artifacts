...
Template for `.planning/codebase/TESTING.md` - captures test framework and
patterns.

**Purpose:** Document how tests are written and run. Guide for adding tests that
...
_Testing analysis: [date]_ _Update when test patterns change_
...
_Testing analysis: 2025-01-20_ _Update when test patterns change_
