...
The git log should read like a changelog of what shipped, not a diary of
planning activity. </core_principle>
...
**Key principle:** Commit working code and shipped outcomes, not planning
process.
