...
NOTE: The backend must support shared serialization via a `shared_serialize` script. See xref:backend-scripts-reference.adoc#_shared_serialize[Scripts Reference] for backend requirements.
