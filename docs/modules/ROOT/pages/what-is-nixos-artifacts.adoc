...
NOTE: The backend must support shared serialization via a `shared_serialize` script. See xref:defining-backends.adoc#shared-serialization[Shared serialization] for backend requirements.
