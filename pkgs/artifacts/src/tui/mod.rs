...
//! terminal management, and background effect processing.
//!
//! ## Submodules
//!
...
//! - `background` - Executes side effects from the app via async channels
...
pub use runtime::{RunResult, run_async, simulate};
