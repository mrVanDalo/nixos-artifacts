...
Gathers "what's next", updates PROJECT.md, then runs requirements → roadmap
cycle.
...
<execution_context> @./.opencode/get-shit-done/workflows/new-milestone.md
...
@./.opencode/get-shit-done/templates/requirements.md </execution_context>

<context>
Milestone name: $ARGUMENTS (optional - will prompt if not provided)

**Load project context:** @.planning/PROJECT.md @.planning/STATE.md
@.planning/MILESTONES.md @.planning/config.json
