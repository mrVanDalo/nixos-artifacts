...
**Purpose:** Document what technologies run this codebase. Focused on "what
executes when you run the code."
...
[Only include dependencies critical to understanding the stack - limit to 5-10
most important]

**Critical:**

- [Package] [Version] - [Why it matters: e.g., "authentication", "database
  access"]
...
_Stack analysis: [date]_ _Update after major dependency changes_
```
...
_Stack analysis: 2025-01-20_ _Update after major dependency changes_
```
