...
Template for `.planning/REQUIREMENTS.md` — checkable requirements that define
"done."
...
_Requirements defined: [date]_ _Last updated: [date] after [trigger]_
```
...
- Typical: Authentication, Content, Social, Notifications, Moderation, Payments,
  Admin
...
**Defined:** 2025-01-14 **Core Value:** Users can share and discuss content with
...
_Requirements defined: 2025-01-14_ _Last updated: 2025-01-14 after initial
definition_
```
