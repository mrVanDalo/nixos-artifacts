...
**Document requirement:** Auto mode requires an idea document via @ reference
(e.g., `/gsd-new-project --auto @prd.md`). If no document provided, error:
...
**If auto mode:** Skip. Extract project context from provided document instead
...
Use question with options that probe what they mentioned — interpretations,
clarifications, concrete examples.
