...
See ./.opencode/get-shit-done/templates/discovery.md `<discovery_protocol>` for
...
6. **Create DISCOVERY.md** using
   ./.opencode/get-shit-done/templates/discovery.md structure:
...
If confidence is LOW: Use question:
