...
Standalone research command. For most workflows, use `/gsd-plan-phase` which
integrates research automatically.
</purpose>
...
- `## RESEARCH INCONCLUSIVE` — Show attempts, offer: Add context/Try different
  mode/Manual
